def origem_destino_iguais(origem, destino, lista_de_erros):
    ...
    if origem == destino:
        lista_de_erros['destino'] = 'Origem e destino são iguais'
...
def data_ida_maior_que_data_volta(data_ida, data_volta, lista_de_erros):
    ...
    if data_ida > data_volta:
        lista_de_erros['data_volta'] = 'Data de volta não pode ser menor do que a data da ida.'


def data_ida_menor_que_data_de_hoje(data_ida, data_pesquisa, lista_de_erros):
    """Verifica se data de ida é menor que a data da pesquisa"""
