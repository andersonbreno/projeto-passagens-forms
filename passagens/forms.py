...
class PassagemForms(forms.ModelForm):
    ...
    class Meta:
        model = Passagem
        fields = '__all__'
        labels = {'data_ida':'Data de Ida', 'data_volta':'Data da Volta', 'informacoes':'Informações', 'classe_viagem':'Classe do Vôo'}
        widgets = {
            'data_ida':DatePicker(),
    ...
    def clean(self):
        ...
        lista_de_erros = {}
        campo_tem_algum_numero(origem, 'origem', lista_de_erros),campo_tem_algum_numero(destino, 'destino', lista_de_erros),
